...
public class MemberUser {
	...
	public MemberUser(Integer member_num, String member_id, String member_pw,
			String member_name, Integer member_age, Integer member_jumin, String member_hobby,
			String member_exist, String member_email, String member_phone, String member_joindate ) {
	...
	public String toString() {
		return "MemberUser [getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
