...
//				System.out.println("getItem의 결과 : " + e.getItem());
//				System.out.println("getStateChange의 결과 : " + e.getStateChange());
				System.out.println(e.getStateChange() == 1 ? "방금 체크됨" : "체크 해제됨");
				// 1보단 ItemEvent.SELECTED 사용이 맞다. Calendar.Friday....
