...
public class A03_Variable {
	...
	public static void main(String[] args) {
		...
		int apple = 100; // 노란색 표시 -> 변수를 선언하고 사용하지 않음.
		
		{ 
			// {} 위에서 만든 apple 변수는 쓸 수 없다.
			// int apple = 10;
			int orange = 30;
			System.out.println(orange);
		}
	
		// 위 orange변수는 {} 가 끝나면서 사라졌기 때문에 다시 선언할 수 있다.
		int orange = 123; // <<===
		System.out.println(orange);
