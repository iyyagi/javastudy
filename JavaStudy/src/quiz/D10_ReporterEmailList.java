...
public class D10_ReporterEmailList {
	...
	/*
	 	1. 어떤 도매인이 몇 개씩 있는지 세어서 출력해보기(munhwa.com/ seoul.co.kr)

	 	2. 각 분야의 기자가 몇 명씩 있는지 세어서 출력해보기

	 	3. 각 신문사 기자가 몇 명씩 있는지
	...
	// step4
	public static void dataCount(HashMap<String, Integer> map, String data) {
		if (map.containsKey(data)) { // key가 value값과 같으면
			map.put(data, map.get(data)+1); // 해당 키값을 가져오고 +1을 한다.
		} else {
			map.put(data, 1); // 기존에 key 값이 없으면 추가(ex 메일경제 회사가 없으면 추가)
		}
	}
	...
	public static void main(String[] args) {
		...
		Matcher matcher2 = emailPattern.matcher(text);
		// step5
		HashMap<String, Integer> companyCount = new HashMap<>();
		HashMap<String, Integer> categoryCount = new HashMap<>();
		HashMap<String, Integer> domainCout = new HashMap<>();
...
//		Pattern reportRegex = Pattern.compile("(.+\t)(.+\t)(.+\t)(\\w+)(@\\w+[.]\\w+[.]?\\w*)");
//		Matcher matcher = reportRegex.matcher(test);
//
////		1. 어떤 도매인이 몇 개씩 있는지 세어서 출력해보기(munhwa.com/ seoul.co.kr)
////
////	 	2. 각 분야의 기자가 몇 명씩 있는지 세어서 출력해보기
////
////	 	3. 각 신문사 기자가 몇 명씩 있는지
//		List<String> emails = new ArrayList<>(); // 모든 이메일이 들어가 있음
//		while(matcher.find()) {
//			for (int i = 0; i < matcher.groupCount(); ++i) {
//				emails.add(matcher.group(5));
//			}
//		}
//		
//		List<String> reports = new ArrayList<>(); // 모든 기자가 들어가 있음
//		
//		
//		HashMap<String, Integer> emailsCount = new HashMap<>();
//		for (String emailReport : emails) {
//			Integer cnt = emailsCount.put(emailReport, 1);
//			
//			if (cnt != null) {
//				emailsCount.put(emailReport, cnt +1);
//			}
//		}
